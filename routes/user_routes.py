...
def user_dashboard():
    """Kept as a compatibility redirect: 404.html, 500.html,
    payment_success.html, payment_failed.html, subscription_cancelled.html,
    admin_users.html's "view as user" link, and admin_routes.py's
    impersonation response all still point here. /dashboard (app.py) is now
    the single real, @jwt_required()-protected dashboard entry point; this
    just forwards there instead of duplicating that rendering/auth logic.
    """
